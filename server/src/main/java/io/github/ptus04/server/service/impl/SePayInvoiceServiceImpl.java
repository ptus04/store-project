...
import io.github.ptus04.server.config.SePayInvoiceProperties;
import io.github.ptus04.server.dto.request.SePayInvoiceCreateRequest;
import io.github.ptus04.server.dto.response.SePayInvoiceCheckResponse;
import io.github.ptus04.server.dto.response.SePayInvoiceCreateResponse;
import io.github.ptus04.server.dto.response.SePayTokenResponse;
...
public class SePayInvoiceServiceImpl implements InvoiceService {
    ...
    public void createInvoice(OrderPaidEvent orderPaidEvent) {
        ...
        InvoiceCreatedEvent invoiceCreatedEvent =
                new InvoiceCreatedEvent(orderPaidEvent.email(), orderPaidEvent.orderCode(), invoiceLink);
